...
__attribute_reloc__ void **font_ptr_ptr_b;
__attribute_reloc__ void (*font_init)(u32);

__attribute_data__ void *font_ptr_eng_a = NULL;
__attribute_data__ void *font_ptr_eng_b = NULL;

__attribute_data__ void *font_ptr_jpn_a = NULL;
...
u32 GetFontCode(u16 code) {
    u32 tmp;
    s32 trail;

    if (*current_lang == LANG_JPN) {
